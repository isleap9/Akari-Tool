...
{
    // MVVM PORT: extracted verbatim from net8 CustomizeTab.Explorer.Associations.cs.
    // Section "File Associations" — 2 toggles.
    public static partial class CustomizeTweaks
    {
        public static TweakDefinition[] ExplorerAssociations(Action<string> Log) => new TweakDefinition[]
        {
            new()
            {
