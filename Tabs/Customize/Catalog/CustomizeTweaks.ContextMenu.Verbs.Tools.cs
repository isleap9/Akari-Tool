...
{
    // MVVM PORT: verbatim from net8 CustomizeTab.ContextMenu.Verbs.Tools.cs.
    // Verb implementations (tools + associations) registered by the ContextMenuEntries table.
