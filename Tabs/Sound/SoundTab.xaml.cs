...
{
    public partial class SoundTab : BaseTab
    {
        private readonly List<Action> _refreshActions = new();

        public SoundTab() => InitializeComponent();
        ...
        private void Build()
        {
            RootPanel.Children.Add(PageHeader("Sound",
                "Control system sounds, audio ducking, and voice activation.",
