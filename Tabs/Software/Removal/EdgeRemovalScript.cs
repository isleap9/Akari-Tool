// Ported 1:1 from Winhance. Generates the PowerShell removal scripts.
...
# Setup logging
$logFolder = ""C:\ProgramData\AkariTool\Logs""
...
function Install-EdgeProtocolRedirect {
    ...
    $scriptsDir = ""C:\ProgramData\AkariTool\OpenWebSearch""
...
""@
    ...
    Register-ScheduledTask -TaskName $repairTaskName -TaskPath ""\AkariTool\"" -Action $repairAction -Trigger $repairTrigger -Settings $repairSettings -Principal $repairPrincipal -Force | Out-Null
...
$stubPath = ""C:\ProgramData\AkariTool\OpenWebSearch\ie_to_edge_stub.exe""
