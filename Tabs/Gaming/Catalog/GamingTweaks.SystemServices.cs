...
{
    // MVVM PORT (Phase 9): the Gaming ▸ System Services section, extracted VERBATIM
    // from build #2's Tabs/Gaming/GamingTab.SystemServices.cs (BuildSystemServices +
    // the ServiceDropdown helper). 37 per-service startup-type dropdowns + 1 toggle
    // (gaming-input-app-preload) = 38 TweakDefinitions. Every Id, service key,
    // recommendedStart/defaultStart, disabledWarning, and Read/Apply body is
    // byte-for-byte the net8 original — service startup types are landmine territory,
    // so NOTHING was reordered, retyped, or "cleaned up".
    //
    // Only framework-mechanical changes vs net8:
    //   • ServiceDropdown made `static` with the tab's `Log` threaded through as a
    //     parameter (net8 captured the instance Log() method + instance ReadDword).
    //   • ReadDword is the existing static GamingTweaks.ReadDword (identical signature).
    //   • BuildSystemServices(StackPanel)+AddSection(...) → SystemServices(Action<string>)
    //     returning the TweakDefinition[] (the rendering layer registers them).
    public static partial class GamingTweaks
    {
        // ── Service dropdown helper ───────────────────────────────────────────

        private static TweakDefinition ServiceDropdown(
            Action<string> Log,
        ...
        public static TweakDefinition[] SystemServices(Action<string> Log)
        {
            ...
            return new[]
            {
                ServiceDropdown(Log, "gaming-sysmain-service",
                ...
                ServiceDropdown(Log, "gaming-windows-search-service",
                ...
                ServiceDropdown(Log, "gaming-print-spooler-service",
                ...
                ServiceDropdown(Log, "gaming-telemetry-service",
                ...
                ServiceDropdown(Log, "gaming-error-reporting-service",
                ...
                ServiceDropdown(Log, "gaming-geolocation-service",
                    "Geolocation Service",
                ...
                ServiceDropdown(Log, "gaming-retail-demo-service",
                    "Retail Demo Service",
                ...
                ServiceDropdown(Log, "gaming-insider-service",
                ...
                ServiceDropdown(Log, "gaming-phone-service",
                    "Phone Service",
                ...
                ServiceDropdown(Log, "gaming-wallet-service",
                    "Wallet Service",
                ...
                ServiceDropdown(Log, "gaming-maps-broker-service",
                ...
                ServiceDropdown(Log, "gaming-fax-service",
                    "Fax Service",
                ...
                ServiceDropdown(Log, "gaming-wmp-network-service",
                ...
                ServiceDropdown(Log, "gaming-mixed-reality-service",
                ...
                ServiceDropdown(Log, "gaming-parental-controls-service",
                ...
                ServiceDropdown(Log, "gaming-payments-nfc-service",
                ...
                ServiceDropdown(Log, "gaming-biometric-service",
                ...
                ServiceDropdown(Log, "gaming-remote-access-manager",
                ...
                ServiceDropdown(Log, "gaming-remote-access-auto",
                ...
                ServiceDropdown(Log, "gaming-compatibility-assistant-service",
                ...
                ServiceDropdown(Log, "gaming-ai-fabric-service",
                ...
                ServiceDropdown(Log, "gaming-sensor-monitoring-service",
                ...
                ServiceDropdown(Log, "gaming-sensor-data-service",
                    "Sensor Data Service",
                ...
                ServiceDropdown(Log, "gaming-telephony-service",
                    "Telephony Service",
                ...
                ServiceDropdown(Log, "gaming-connected-devices-platform-service",
                ...
                ServiceDropdown(Log, "gaming-smart-card-services",
                    "Smart Card Services",
                ...
                ServiceDropdown(Log, "gaming-spot-verifier-service",
                ...
                ServiceDropdown(Log, "gaming-remote-desktop-port-redirector",
                ...
                ServiceDropdown(Log, "gaming-touch-keyboard-service",
                ...
                ServiceDropdown(Log, "gaming-xbox-auth-manager",
                ...
                ServiceDropdown(Log, "gaming-xbox-game-save",
                    "Xbox Live Game Save",
                ...
                ServiceDropdown(Log, "gaming-xbox-networking",
                ...
                ServiceDropdown(Log, "gaming-midi-service",
