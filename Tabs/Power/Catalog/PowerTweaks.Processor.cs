...
{
    // MVVM PORT: extracted verbatim from net8 PowerTab.Processor.cs.
    // Sections "Processor Power Management", "Processor Advanced Settings".
    public static partial class PowerTweaks
    {
        ...
        public static TweakDefinition[] ProcessorPower(Action<string> Log)
        {
            ...
            return new[]
            {
                ...
                new TweakDefinition
                {
                    ...
                    Apply = on =>
                    {
                        ...
                        Log($"Power Throttling {(on ? "enabled" : "disabled")}.");
                    }
                },
            };
        }
        ...
        public static TweakDefinition[] ProcessorAdvanced(Action<string> Log)
        {
            const string SG = "54533251-82be-4824-96c1-47b60b740d00";
            return new[]
            {
