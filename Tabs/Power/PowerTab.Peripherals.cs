...
namespace AkariTool.Tabs.Power
{
    public partial class PowerTab
    {
        ...
        private void BuildInternetExplorer(StackPanel panel)
        {
            const string SG  = "02f815b5-a5cf-4c84-bf20-649d1f75d3d8";
            const string SET = "4c793e7d-a264-42e1-87d3-7a0d2f523ccd";
            var section = TweakHelpers.BuildSection(panel, "Internet Explorer");
            _refreshActions.Add(TweakHelpers.AddTweakRow(section, new TweakDefinition
            {
        ...
        private void BuildDesktopBackground(StackPanel panel)
        {
            const string SG  = "0d7dbae2-4294-402a-ba8e-26777e8488cd";
            const string SET = "309dce9b-bef4-4119-9921-a851fb12f0f4";
            var section = TweakHelpers.BuildSection(panel, "Desktop Background Settings");
            _refreshActions.Add(TweakHelpers.AddTweakRow(section, new TweakDefinition
            {
        ...
        private void BuildWirelessAdapter(StackPanel panel)
        {
            const string SG  = "19cbb8fa-5279-450e-9fac-8a3d5fedd0c1";
            const string SET = "12bbebe6-58d6-4636-95bb-3217ef867c1a";
            var section = TweakHelpers.BuildSection(panel, "Wireless Adapter Settings");
            _refreshActions.Add(TweakHelpers.AddTweakRow(section, new TweakDefinition
            {
        ...
        private void BuildSleep(StackPanel panel)
        {
            const string SG_SLEEP = "238c9fa8-0aad-41ed-83f4-97be242c8f20";
            var section = TweakHelpers.BuildSection(panel, "Sleep");
            ...
            _refreshActions.Add(TweakHelpers.AddTweakRow(section, new TweakDefinition
            {
                ...
                Apply = on =>
                {
                    ...
                    Service?.Log($"Hibernation {(on ? "enabled" : "disabled")}.");
                }
            }));
            ...
            _refreshActions.Add(TweakHelpers.AddTweakRow(section, new TweakDefinition
            {
                ...
                Apply = on =>
                {
                    ...
                    Service?.Log($"Fast Startup {(on ? "enabled" : "disabled")}.");
                }
            }));
        }
        ...
        private void BuildUSB(StackPanel panel)
        {
            const string SG_USB = "2a737441-1930-4402-8d77-b2bebba308a3";
            var section = TweakHelpers.BuildSection(panel, "USB Settings");
