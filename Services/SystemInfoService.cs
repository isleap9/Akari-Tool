...
/// <summary>
/// Shared registry/WMI system-information lookups. Used by the Home banner (and
/// later the Tools tab's System Information card) so both read through one
/// implementation. Ported from the migration branch; WMI stays on a background
/// thread because it is slow.
/// </summary>
