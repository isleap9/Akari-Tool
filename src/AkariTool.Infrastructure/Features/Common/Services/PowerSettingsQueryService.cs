...
/// <summary>
/// Native (PowrProf) reads for power settings and power plans. Ported 1:1 from
/// Winhance's PowerSettingsQueryService; battery-gating probes live in
/// <see cref="HardwareDetectionService"/> (Akari uses GetSystemPowerStatus, not WMI).
/// </summary>
public sealed class PowerSettingsQueryService(
    IAkariLogService logService) : IPowerSettingsQueryService
{
