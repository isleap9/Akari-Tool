...
namespace AkariTool.Features.Common.Converters;

/// <summary>
/// Converts icon names and icon packs to IconElement controls.
/// Supports Material, MaterialDesign, and Fluent icon packs.
/// Returns IconElement types (PathIcon, FontIcon, FluentIcon).
/// Winhance IconConverter 1:1 port — the reflection branch reads Icon/IconPack
/// off the bound SettingItemViewModel row.
/// </summary>
