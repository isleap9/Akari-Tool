...
{
    // MVVM PORT: extracted verbatim from net8 CustomizeTab.Explorer.Behavior.cs.
    // Section "Behavior" — 7 toggles.
    public static partial class CustomizeTweaks
    {
        public static TweakDefinition[] ExplorerBehavior(Action<string> Log) => new TweakDefinition[]
        {
            new()
            {
